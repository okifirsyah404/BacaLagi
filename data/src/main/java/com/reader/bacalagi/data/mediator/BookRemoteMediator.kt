...
//        loadType: LoadType,
//        state: PagingState<Int, ProductWithBookModel>
//    ): MediatorResult {
...
//    }
//
//    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, ProductWithBookModel>): BookRemoteKeysModel? {
...
//    }
//
//    private suspend fun getRemoteKeyForFirstItem(state: PagingState<Int, ProductWithBookModel>): BookRemoteKeysModel? {
//        return state.pages.firstOrNull { it.data.isNotEmpty() }?.data?.firstOrNull()?.let { book ->
//            database.bookRemoteKeysDao().getRemoteKeysId(book.id)
//        }
//    }
//
//    private suspend fun getRemoteKeyClosestToCurrentPosition(state: PagingState<Int, ProductWithBookModel>): BookRemoteKeysModel? {
